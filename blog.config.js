...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '正面人物', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个技术很菜的小白🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://beifeng.pp.ua/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '技术, 博客, 分享', // 网站关键词 英文逗号隔开
